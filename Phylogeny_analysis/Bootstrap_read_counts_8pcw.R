...
my_working_directory="/lustre/scratch119/casm/team154pc/ms56/fetal_HSC/fetal_8wks/tree_bootstraps"
...
sapply(R_function_files[c(1,2,3)],source)
...
for(i in 1:nsim) {
  ...
  Run_ID = paste0("Bootstrap_8pcw_",ids::random_id(1,8))
  dna_string_file = paste0("/lustre/scratch119/casm/team154pc/ms56/fetal_HSC/tree_bootstraps/mpboot_files/DNA_string_file_bootstrap_8pcw_",Run_ID,".fa")
  mpboot_tree_file = paste0(dna_string_file,".treefile")
  tree_file_path = paste0("/lustre/scratch119/casm/team154pc/ms56/fetal_HSC/tree_bootstraps/final_trees/Tree_",Run_ID,".tree")
  
  #Load the reduced mats and params file from previous filtering
  load("/lustre/scratch119/casm/team154pc/ms56/fetal_HSC/filtering_runs/mats_and_params/mats_and_params_a5_8wks_postMS_both_reduced")
  ...
  COMB_mats=list_subset(COMB_mats,select_vector = (filter_params$germline_pval<0.001 & filter_params$bb_rhoval>0.1)) #Pre-apply the beta-binomial filter, as boot-strapping
