...
sample_names<-c("8 pcw\nPrivate - clonal","8 pcw\nAll","8pcw\nShared","8pcw\nPrivate - subclonal","18 pcw\nPrivate - clonal","18 pcw\nAll","18pcw\nShared","18pcw\nPrivate - subclonal")
...
plot(combined_plot)
ggsave(combined_plot,filename = "Figures/Combined/Mutation_signatures_96profile.pdf",device=cairo_pdf,height=11.7,width=8.3)
