...
filtered_muts_file = "Data/8pcw/Filtered_mut_set_annotated_8pcw"
...
pdf("~/Documents/Foetal_paper_revisions/MPBoot_vs_iqtree_comparisons_8pcw.pdf",width = 15,height=6)
...
pdf("~/Documents/Foetal_paper_revisions/MPBoot_vs_SCITE_comparisons_8pcw.pdf",width = 15,height=6)
...
ggsave("~/Documents/Foetal_paper_revisions/Genotype_heatmap_8pcw.pdf",p1,width=4,height=4.5)
...
p2<-data.frame(type=c("data",rep("random_shuffles",nrand)),disagreement_score=c(dat,rand))%>%
  ...
  labs(title="Internal consistency of 8pcw genotypes")
ggsave("~/Documents/Foetal_paper_revisions/Internal_consistency_8pcw.pdf",p2,width=3,height=3)
