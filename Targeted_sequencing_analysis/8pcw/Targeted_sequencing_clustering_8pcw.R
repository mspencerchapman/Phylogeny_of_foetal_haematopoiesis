...
pdf("Figures/8pcw/Tissue_clustering_heatmap_8pcw.pdf")
heatmap(sim_mat,
        scale = "none",
        col=viridis,
...
pdf("Figures/8pcw/Tissue_mutation_clustering_heatmap_8pcw.pdf")
...
lut=colfunc(101)
scale = (length(lut)-1)
pdf("Figures/8pcw/Scale_bar_tissuemut_clustering_8pcw.pdf")
